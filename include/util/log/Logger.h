...
template <typename... Args>
inline void tracef(std::string_view fmt, Args&&... args)
{
...
template <typename... Args>
inline void infof(std::string_view fmt, Args&&... args)
{
    logf(Level::Info, fmt, std::forward<Args>(args)...);
}

template <typename... Args>
inline void warnf(std::string_view fmt, Args&&... args)
{
    logf(Level::Warn, fmt, std::forward<Args>(args)...);
}

template <typename... Args>
inline void errorf(std::string_view fmt, Args&&... args)
{
    logf(Level::Error, fmt, std::forward<Args>(args)...);
}

template <typename... Args>
inline void criticalf(std::string_view fmt, Args&&... args)
{
    logf(Level::Critical, fmt, std::forward<Args>(args)...);
}
...
template <typename... Args>
inline void tracef(ILogger& logger, std::string_view fmt, Args&&... args)
{
    logf(logger, Level::Trace, fmt, std::forward<Args>(args)...);
}

template <typename... Args>
inline void debugf(ILogger& logger, std::string_view fmt, Args&&... args)
{
    logf(logger, Level::Debug, fmt, std::forward<Args>(args)...);
}

template <typename... Args>
inline void infof(ILogger& logger, std::string_view fmt, Args&&... args)
{
    logf(logger, Level::Info, fmt, std::forward<Args>(args)...);
}

template <typename... Args>
inline void warnf(ILogger& logger, std::string_view fmt, Args&&... args)
{
    logf(logger, Level::Warn, fmt, std::forward<Args>(args)...);
}

template <typename... Args>
inline void errorf(ILogger& logger, std::string_view fmt, Args&&... args)
{
    logf(logger, Level::Error, fmt, std::forward<Args>(args)...);
}

template <typename... Args>
inline void criticalf(ILogger& logger, std::string_view fmt, Args&&... args)
{
    logf(logger, Level::Critical, fmt, std::forward<Args>(args)...);
}
