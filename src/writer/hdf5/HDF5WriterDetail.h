...
inline void append1D(H5::DataSet& ds, const H5::DataType& h5type, const CType* data, hsize_t n)
{
...
// ---------------------------------------------------------------------------
template <typename CType>
inline void append2D(H5::DataSet& ds, const H5::DataType& h5type, const CType* data, hsize_t nSamples, hsize_t arrayLen)
{
...
template <>
inline const H5::PredType& mapNativeType<double>()
{
    return H5::PredType::NATIVE_DOUBLE;
}

template <>
inline const H5::PredType& mapNativeType<float>()
{
    return H5::PredType::NATIVE_FLOAT;
}

template <>
inline const H5::PredType& mapNativeType<int32_t>()
{
    return H5::PredType::NATIVE_INT32;
}

template <>
inline const H5::PredType& mapNativeType<int64_t>()
{
    return H5::PredType::NATIVE_INT64;
}

template <>
inline const H5::PredType& mapNativeType<uint8_t>()
{
...
template <>
inline double fillValue<double>()
{
    return std::numeric_limits<double>::quiet_NaN();
}

template <>
inline float fillValue<float>()
{
