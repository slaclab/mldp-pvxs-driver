...
std::unique_ptr<IExecutionState> makeExplainExecutionState(const plan::PhysicalExplain& node, const plan::PhysicalNodePtr&, const ExecutionContext& context, QueryStats& stats)
{
