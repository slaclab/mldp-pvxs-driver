...
std::unique_ptr<IExecutionState> makeDropTableExecutionState(const plan::PhysicalDropTable& node, const plan::PhysicalNodePtr&, const ExecutionContext& context, QueryStats& stats)
{
