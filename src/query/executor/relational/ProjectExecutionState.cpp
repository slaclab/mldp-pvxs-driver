...
std::unique_ptr<IExecutionState> makeProjectExecutionState(const plan::PhysicalProject& node, const plan::PhysicalNodePtr&, const ExecutionContext& context, QueryStats& stats)
{
